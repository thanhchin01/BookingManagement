    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-xs p-4 animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-bold text-slate-300 block">Mã số giao dịch Ngân hàng (TxID / Ref):</label>
          <input
            type="text"
            required
            ...
            className="w-full bg-slate-950 border border-slate-850 p-3 rounded-xl text-xs text-white outline-none focus:border-emerald-500/50 font-mono"
          />
