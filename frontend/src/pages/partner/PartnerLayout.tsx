    ...
    <div className="min-h-screen bg-slate-950 flex font-sans text-slate-100 select-none">
      ...
      >
        ...
        <div className="p-4 border-t border-slate-800/80">
          <button
            onClick={onLogout}
            className={`w-full flex items-center gap-3.5 px-4 py-3.5 bg-slate-950/40 hover:bg-red-500/10 hover:text-red-400 text-slate-400 rounded-xl transition duration-150 border border-slate-850 hover:border-red-500/20 cursor-pointer text-left`}
          >
